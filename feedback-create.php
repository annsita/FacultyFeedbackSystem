...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO feedback (d_id,Message,Reply,u_id) VALUES (?,?,?,?)");

        if($stmt->execute([ $d_id,$Message,$Reply,$u_id  ])) {
                $stmt = null;
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group">
                                ...
                                <input type="hidden" placeholder="d_id" required name="d_id" class="form-control" value="<?php echo $_SESSION['dept_id']; ?>">
						...
						<div class="form-group">
                                 ...
                                 <input type="hidden" name="Reply" class="form-control" placeholder="Reply" value="HOD is not replied yet">
								 <?php echo $Reply; ?>
						...
						<div class="form-group">
                                ...
                                <input type="hidden" placeholder="u_id" required name="u_id" class="form-control" value="<?php echo $_SESSION['fid']; ?>">
