...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO options (option_data,qn_id,option_mark) VALUES (?,?,?)");

        if($stmt->execute([ $option_data,$qn_id,$option_mark  ])) {
                $stmt = null;
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
						...
						<div class="form-group">
                                <label>Mark</label>
                                <input type="number" name="option_mark" class="form-control" value="<?php echo $option_mark; ?>">
