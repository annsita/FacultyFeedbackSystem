...
<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $uname=$_POST['uname'];
    $pass=$_POST['password'];
    $sql="select * from faculty where f_username='$uname' and f_password='$pass'";
    ...
    if($nrows>0)
    {
      ...
      $utype=mysqli_fetch_assoc($result);      
		...
		{echo "Sorry, Admin is not approved your registration";}
	...
	<body>
		...
		<div class="top-nav">
					<ul>
						...
						<li><a href="login1.php">Student Area</a></li>
						<li><a href="login2.php">Faculty Area</a></li>
					</ul>
				</div>
				<div class="clear"> </div>
				<!---End-top-nav--->
				  	...
				  	<h3></h3>
					    ...
					    <form method="post">
						   ...
						   <div>
						   		...
						   		<p><a href="faculty-register.php">New Faculty? Register here</a></p>
				          </div>
					    </form>
