            ...
            <div class="row">
                <div class="col-md-12">
                  <div class="page-header clearfix">
                    ...
                    $orderBy = array('Message', 'Reply', 'u_id');
                    $order = 'Feed_id';
                    ...
                    $sql = "SELECT * FROM feedback where d_id=".$_SESSION['dept_id']." ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM feedback
                            WHERE CONCAT_WS (Message,Reply,u_id)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
									...
									//	echo "<th><a href=?search=$search&sort=&order=u_id&sort=$sort>Feedback From</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . $row['Message'] . "</td>";echo "<td>" . $row['Reply'] . "</td>";
									//echo "<td>" . prav_get("f_name","faculty","faculty_id",$row['u_id']) . "</td>";
                                        echo "<td>";
                                       ...
                                       echo "<a href='feedback-update.php?Feed_id=". $row['Feed_id'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i>Give Reply</a>";
...
<?php
					...
					<?php
					  ...
					  else
					  {
						...
						echo "Sorry you are not an HOD, this page is for HOD's only";  
					  }
						  ?>
