...
$file=prav_upload($f_photo);
	echo $file;
        if($stmt->execute([ $f_name,$f_email,$f_gender,$file,$f_username,$f_password,$f_isactive,$f_grade,$desig_id,$dept_id  ])) {
                $stmt = null;
                 ?>
			 <script>alert("Faculty registered, please wait for admin's approval !!");
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
                                <label>Email</label>
                                 ...
                                 <input type="email" required name="f_email" class="form-control" value="<?php echo $f_email; ?>">
						...
						<div class="form-group">
								...
								<input type="hidden" name="f_isactive" class="form-control" value="0">
                        ...
                        <a href="login2.php" class="btn btn-secondary">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
