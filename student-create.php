	...
	$fnn=date("YmdHis").".".$ext;
	 $target_dir = "uploads/";
      ...
      if (move_uploaded_file($_FILES["student_photo"]["tmp_name"], $target_file)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO student (student_name,student_contact,student_email,student_gender,student_photo,student_regno,student_dob,student_isactive,dept_id) VALUES (?,?,?,?,?,?,?,?,?)");

        if($stmt->execute([ $student_name,$student_contact,$student_email,$student_gender,$target_file,$student_regno,$student_dob,$student_isactive,$dept_id  ])) {
                $stmt = null;
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
                                <label>Email</label>
                                <input type="email" name="student_email" maxlength="100"class="form-control" value="<?php echo $student_email; ?>">
